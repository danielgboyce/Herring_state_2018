...
spher<-ddply(subset(rvw,year!=1997,select=c('totwgt','lon','lat','year')),.(year),.fun=ff,.progress='text')
...
mod<-gam(y2~s(lon,lat,k=40),data=d,family=binomial)
...
rngher<-ddply(subset(rvw,year!=1983,select=c('totno','lon','lat','year')),.(year),.fun=f,.progress='text')
...
herspat<-herspat[,!(names(herspat) %in% c('herlrv.sp.n','her.sp.n'))]
herspat.spawnar<-herspat

#save(herspat.spawnar,file='herspat.spawnar.RData')
#load('herspat.spawnar.RData')
...
otj$her.dur2.rv<-ifelse(ot$her.dur2.rv<0,0,ot$her.dur2.rv)
...
save(data,file='SPERA_andata_spawnar.RData')
...
#CREATE TIME-LAGGED VERSIONS OF SOME VARS
#data<-data[,1:118]
data<-slide(data,Var='her.ssb',slideBy=3,NewVar='her.ssb.tplus3')
data<-slide(data,Var='her.ssb',slideBy=4,NewVar='her.ssb.tplus4')
data<-slide(data,Var='her.ssb',slideBy=5,NewVar='her.ssb.tplus5')
data<-slide(data,Var='her.ssb',slideBy=6,NewVar='her.ssb.tplus6')
data<-slide(data,Var='her.len.rv',slideBy=-1,NewVar='her.len.rv.tmin1')
data<-slide(data,Var='her.len.rv.se',slideBy=-1,NewVar='her.len.rv.se.tmin1')
data<-slide(data,Var='her.cf.rv',slideBy=-1,NewVar='her.cf.rv.tmin1')
data<-slide(data,Var='her.cf.cat',slideBy=-1,NewVar='her.cf.cat.tmin1')
data<-slide(data,Var='her.f',slideBy=-1,NewVar='her.f.tmin1')
data<-slide(data,Var='her.rec1',slideBy=3,NewVar='her.rec1.tplus3')
data<-slide(data,Var='her.rec1',slideBy=2,NewVar='her.rec1.tplus2')
data<-slide(data,Var='her.rec1',slideBy=1,NewVar='her.rec1.tplus1')


###########################################################

##CALCULATE HERRING 'STATE' VARIABLE
b<-subset(data,is.na(year)==FALSE,select=c('year','her.ssb','her.cf.rv','her.len.rv','her.spcv','her.waa','her.metai.rv','her.fmass.rv','her.szpe.rv','her.spvar'))
b$her.spcv<-b$her.spcv*-1
b$her.spvar<-b$her.spvar*-1
