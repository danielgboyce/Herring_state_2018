...
setwd(figsdir)
pdf('herring_indices_accel_v3.pdf',height=10,width=8)
par(mar=c(4,12,1,1))
...
axis(2,at=odat$id,labels=odat$lbl,las=1)
box()
text(-.75,17.25,'Poor',adj=0,cex=1.5)
text(.75,17.25,'Good',adj=1,cex=1.5)
...
plot(0,0,xlim=c(-.18,.05),yaxt='n',ylab='',xlab='Rates of change',pch='.',col='white',ylim=c(1,17))
rect(-2,-2,0,30,col='darkseagreen1',border=NA)
rect(0,-2,2,30,col='lightgoldenrod1',border=NA)
...
box()
text(-.15,17.25,'Worsening',adj=0,cex=1.5)
text(.04,17.25,'Improving',adj=1,cex=1.5)
dev.off()
